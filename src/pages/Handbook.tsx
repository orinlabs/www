...
export default function Handbook() {
  ...
  return (
    <div className="flex min-h-0 flex-1 gap-8 lg:gap-12 xl:gap-16 overflow-hidden">
      {/* Sidebar */}
      <aside className="hidden lg:block w-64 shrink-0 overflow-y-auto pb-8 pr-2">
              ...
              <div key={navPage.slug}>
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="rounded-md p-1.5 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700 dark:hover:bg-neutral-800/60 dark:hover:text-neutral-200 transition-colors"
                  >
                    <ChevronRight
                      className={cn(
                        ...
                        return (
                          <Link
                            ...
                            className={cn(
                              ...
                              item.level > 2 ? 'px-5 text-xs' : 'px-2.5',
                              activeHeading
      ...
      {/* Content */}
      <article ref={contentRef} className="min-w-0 flex-1 overflow-y-auto pb-10 pr-1">
...
function LastEditor({ page }: { page: HandbookPage }) {
  ...
  return (
    <div className="mt-12 flex max-w-3xl items-center gap-3 border-t border-neutral-200 pt-6 text-sm text-neutral-600 dark:border-neutral-800 dark:text-neutral-400">
      {editor.avatarUrl ? (
        <img
